...
<p align="center">
  <strong>HappyHorse API access for AI agents: run video generation operations, poll asynchronous results, and check pricing through one focused MCP server.</strong>
</p>
...
<p align="center">
  ...
  <a href="https://github.com/runapi-ai/happyhorse-mcp"><img src="https://img.shields.io/badge/GitHub-runapi--ai%2Fhappyhorse--mcp-24292f?style=flat-square" alt="GitHub repository"></a>
...
Use this per-model server when an agent should stay scoped to HappyHorse. Use [`@runapi.ai/mcp`](https://github.com/runapi-ai/mcp) when one assistant should discover every RunAPI model line.
...
Model availability can change between releases. Use `check_pricing` or the [HappyHorse model page](https://runapi.ai/models/happyhorse) for the current catalog view.
...
The assistant calls `check_pricing` and can link to the [HappyHorse model page](https://runapi.ai/models/happyhorse) for the canonical catalog entry.
...
| Resource | URL |
|---|---|
| HappyHorse model page | [https://runapi.ai/models/happyhorse](https://runapi.ai/models/happyhorse) |
| npm package | [@runapi.ai/happyhorse-mcp](https://www.npmjs.com/package/@runapi.ai/happyhorse-mcp) |
| GitHub repository | [runapi-ai/happyhorse-mcp](https://github.com/runapi-ai/happyhorse-mcp) |
